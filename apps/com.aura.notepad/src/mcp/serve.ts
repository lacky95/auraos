/**
 * MCP over HTTP for the Notepad app — the plumbing every MCP this app serves
 * shares. Same shape as `apps/com.aura.settings/src/mcp/serve.ts`: a new MCP
 ...
 *
 * The one long-lived thing — the filesystem MCP child process — is NOT tied
 * to this per-request lifetime; it lives in `filesystem.ts` as a singleton.
 *
